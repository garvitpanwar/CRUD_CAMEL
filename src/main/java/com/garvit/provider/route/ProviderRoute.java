...
//import com.garvit.provider.mapper.ProviderMapper;
//import com.garvit.provider.model.Provider;
//import com.garvit.provider.mapper.ProviderService;
//import jakarta.enterprise.context.ApplicationScoped;
//import jakarta.inject.Inject;
//import org.apache.camel.builder.RouteBuilder;
//import org.apache.camel.model.rest.RestBindingMode;
...
//                .log("Adding new provider: ${body}")
//                .bean(providerService, "saveProvider(${body})")
//                .log("Provider added with ID: ${body.id}")
//                .setBody(constant(new ResponseMessage("Provider added successfully")));
//
//        // Get All Providers
//        from("direct:getAllProviders")
//                .routeId("get-all-providers-route")
//                .log("Fetching all providers")
//                .bean(providerService, "getAllProviders");
//
//        // Get Provider by ID
//        from("direct:getProviderById")
//                .routeId("get-provider-by-id-route")
//                .log("Fetching provider with ID: ${header.id}")
//                .bean(providerService, "getProviderById(${header.id})")
//                .choice()
//                .when(body().isNull())
//                .setHeader(Exchange.HTTP_RESPONSE_CODE, constant(404))
//                .setBody(constant(new ResponseMessage("Provider not found")))
//                .end();
//
//        // Update Provider
//        from("direct:updateProvider")
...
//                .setBody(constant(new ResponseMessage("Provider deleted successfully")))
//                .otherwise()
//                .setHeader(Exchange.HTTP_RESPONSE_CODE, constant(404))
//                .setBody(constant(new ResponseMessage("Provider not found")))
//                .end();
